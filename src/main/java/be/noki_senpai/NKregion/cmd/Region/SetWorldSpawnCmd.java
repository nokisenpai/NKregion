...
public class SetWorldSpawnCmd
{
	PlayerManager playerManager = null;
	QueueManager queueManager = null;
	RegionManager regionManager = null;

	public SetWorldSpawnCmd(PlayerManager playerManager, QueueManager queueManager, RegionManager regionManager)
	{
	...
	public boolean setWorldSpawn(CommandSender sender, String[] args)
	{
		if(args.length < 5)
		{
			sender.sendMessage(ChatColor.GREEN + "/land setWorldSpawn <regionName> <x> <y> <z>");
			return true;
		}
		...
		regionManager.setWorldSpawnRegion(args[1] , x , y , z);

		sender.sendMessage(ChatColor.GREEN + "Spawn pour world de la region " + ChatColor.AQUA + args[1] + ChatColor.GREEN + " : " + x + " | " + y + " | " + z);
